...
Lemma isaprop_is_precategory_fun (C C' : precategory_data) (F : precategory_ob_mor_fun C C'):
...
Definition precategory_fun_full_img {C D: precategory} (F : precategory_fun C D) :
